function  xsec = simulate_core_shell(rho_dye, tensor_type, position_type, ...
    wavelength, medium, R0, d, N_inc, N_nmax, N_mie, N_esa)
%simulate_core_shell Simulates the optical response of a core-shell cluster
%
...
% - R0: sphere radius
% - d: dipole-sphere distance
% - N_inc: [optional, default: 36] number of incident angles
% - N_nmax: [optional, default: 50] number of incident angles
% - N_mie: [optional, default: 50] number of incident angles
% - N_esa: [optional, default: 500] number of incident angles
%
% RETURNS: matrix of cross-section spectra
%
% DEPENDS: alpha_bare, cluster_shell, epsilon_Ag, spectrum_coreshell_oa
%
...
% if we ask for fewer than 4 directions of incidence, switch to x,y,z
if N_inc > 4
    quad_method = 'gl';
else
    quad_method = 'cheap';
...
material.epsilon = epsilon_Ag(wavelength);
...
xsec = spectrum_coreshell_oa(cl, material, quad_method, N_inc, N_nmax, N_mie, N_esa, inversion);
